...
const sunucu = ayarlar.sunucuıd; //sunucu ıd
...
let yazı = 'Excuvate Guard | Ban Koruması'
...
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED1)
} else { };});
...
let yazı = 'Excuvate Guard | Webhook Koruması'
const EMBED3 = new Discord.MessageEmbed()
.setAuthor(yazı, guild.iconURL({dynamic:true}))
.setDescription(`${uye} (\`${uye.id}\`) Webhook Oluşturdu.\n\n ${uye} üyesini sunucudan \`yasakladım.\``)
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED3)
} else { };
} else { };})});
//-----------------------------------WEBHOOK KORUMA--------------------------------\\
...
let yazı = 'Excuvate Guard | Kanal Koruması'
const EMBED4 = new Discord.MessageEmbed()
.setAuthor(yazı, guild.iconURL({dynamic:true}))
.setDescription(`${uye} (\`${uye.id}\`) Kanal oluşturdu.\n\n ${uye} üyesini sunucudan \`yasakladım.\``)
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED4)
} else { };} else { };});});
...
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED5)
} else { };
} else { };
})});
...
let yazı = 'Excuvate Guard | Rol Koruması'  
const EMBED6 = new Discord.MessageEmbed()
.setAuthor(yazı, guild.iconURL({dynamic:true}))
.setDescription(`${uye} (\`${uye.id}\`) ${role.name} Rolünü Sildi.\n\n ${uye} üyesini sunucudan \`yasakladım.\``)
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED6)
} else { };
} else { };});});
//-----------------------------------ROL KORUMA--------------------------------\\
...
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED7)
} else { };
} else { };
} else { };
});
...
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED8)
} else { };
} else { };});});
//-----------------------------------ROL KORUMA--------------------------------\\
...
let yazı = 'Excuvate Guard | Bot Koruması'  
const EMBED9 = new Discord.MessageEmbed()
.setAuthor(yazı, guild.iconURL({dynamic:true}))
.setDescription(`${uye} (\`${uye.id}\`) Sunucuya ${member} Botunu Ekledi.\n\n ${uye} üyesini sunucudan \`yasakladım.\``)
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED9)
} else { };
} else { };
} else { };});});
//-----------------------------------BOT KORUMA--------------------------------\\
...
let yazı = 'Excuvate Guard | Url Koruması'  
...
.setColor('WHITE')
.setFooter(` - `)
client.channels.cache.get(ayarlar.guardlog).send(EMBED10)
} else { };
...
newGuild.roles.cache.filter(r => { return (arr.some(a => r.permissions.has(a)) && !botroles.includes(r.id) && r.rawPosition < kullanici.roles.highest.rawPosition)}).map(x => { console.log(x.name);
x.edit({permissions: x.permissions.remove(arr)});
let yazı = 'Excuvate Guard | Sunucu Koruması'  
const EMBED11 = new Discord.MessageEmbed()
.setAuthor(yazı, newGuild.iconURL({dynamic:true}))
.setDescription(`${uye} (\`${uye.id}\`) Sunucu Ayarlarını Güncelledi.\n\n ${uye} üyesini sunucudan \`yasakladım.\``)
.setColor('WHITE')
.setFooter(ayarlar.foother)
client.channels.cache.get(ayarlar.guardlog).send(EMBED11)});
} else { };
} else { };
} else { };});});
...
//-----------------------------------SUNUCU KORUMA--------------------------------\\
    ...
    client.on("ready", (message) => {
        client.user.setPresence({ activity: { name: ayarlar.durum, type: ayarlar.type }, status: ayarlar.status  })
        client.channels.cache.get(ayarlar.botvoice).join().then(shelves => {
